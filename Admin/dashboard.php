...
<body>
  ...
  <div class="admin-content">
    <div class="admin-header">
      <div>
        <h1 style="color: white; font-size: 1.8rem; margin-bottom: 5px;">Welcome <?php echo $_SESSION['admin']; ?></h1>
    ...
    <div class="admin-card" style="padding: 20px;">
      <h2 style="color: white; margin-bottom:-4px;  text-align: center;"><i class="fas fa-search"></i><a href="check_rollno.php"> Edit Student Details</a></h2>
    </div>

    <div class="admin-card" style="padding: 20px;">
      <h2 style="color: white; margin-bottom:-4px;  text-align: center;"><i class="fas fa-bell"></i><a href="quick_msg.php"> Add Quick Message</a></h2>
    </div>

    <div class="admin-card" style="padding: 20px;">
      <h2 style="color: white; margin-bottom:-4px;  text-align: center;"><a href="exam.php"><i class="fas fa-clipboard-check"></i> Add Exam Result</a></h2>
    </div>

    <div class="admin-card" style="padding: 20px;">
      <h2 style="color: white; margin-bottom:-4px;  text-align: center;"><a href="notes_upload.php"><i class="fas fa-upload"></i> Upload Notes</a></h2>
    </div>
