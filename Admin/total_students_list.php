...
<body>
  ...
  <div class="admin-content">
    <div class="admin-header">
      <h1 style="color: white; font-size: 1.8rem;"><i class="fas fa-list" style="color: var(--primary);"></i> <?php echo ucfirst(htmlspecialchars($s_status)); ?> Students</h1>
    </div>
        ...
        <tbody>
          ...
          if($students->num_rows > 0) {
            while($student = $students->fetch_assoc()) {
              $statusColor = $student['status'] == 'approve' ? '#10b981' : ($student['status'] == 'cancel' ? '#ef4444' : '#f59e0b');
          ?>
